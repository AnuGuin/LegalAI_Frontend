...
import LawyerSettingsModal from "./lawyer-settings-modal"
...
export function NavUser({
  ...
  const [activeTab, setActiveTab] = useState<"profile" | "bar_verification" | "billing" | "data" | "about">("profile")
      ...
      <SidebarMenu>
        <SidebarMenuItem>
          <DropdownMenu>
            ...
            <DropdownMenuContent
              className="z-50 w-(--radix-dropdown-menu-trigger-width) min-w-56 p-2 backdrop-blur-sm border-0 dark:border-2 dark:border-zinc-500/20 rounded-2xl shadow-[4px_8px_12px_2px_rgba(0,0,0,0.1)] dark:shadow-[4px_8px_12px_2px_rgba(0,0,0,0.2)] bg-popover/80 dark:bg-zinc-900/50 data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-95 data-[side=bottom]:slide-in-from-top-2 data-[side=left]:slide-in-from-right-2 data-[side=right]:slide-in-from-left-2 data-[side=top]:slide-in-from-bottom-2"
            ...
            >
              ...
              <DropdownMenuGroup className="space-y-1 py-1">
                <DropdownMenuItem
                  ...
                  className="flex items-center p-2 rounded-xl transition-all duration-200 cursor-pointer group border border-transparent hover:bg-accent hover:border-border/50 hover:shadow-sm focus:bg-accent focus:text-accent-foreground w-full"
                >
